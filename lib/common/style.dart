...
TextStyle subTitleText = GoogleFonts.fredoka(color: Colors.grey, fontSize: 20);
TextStyle nameText = GoogleFonts.fredoka(color: Colors.black, fontSize: 16);
TextStyle subNameText = GoogleFonts.fredoka(color: Colors.grey, fontSize: 14);
